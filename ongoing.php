...
<body>
    ...
    <div class="cplayers" >
      <div class="playerrow" >
          <h2 class="tittle5" style="font-family: Days One; align-items: center; "></h2>
         
      </div> 
  </div>

  <div class="image-containerpoints">
    <img src="./images/points/prize.jpg" alt="Image 1" class="prize">
  ...
  <div class="cplayers" >
    <div class="playerrow" >
        ...
        <a href="./register.php"><div class="back-button" style="color: #fff; font-family: Days One;">
           Register
      </div></a>
    </div>
