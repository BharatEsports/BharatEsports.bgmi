...
<body>
    ...
    <div class="formcontainer">
        ...
        <div class="form-container">
          <div class="cplayers" >
            <div class="playerrow" >
                <h2 class="tittle5" style="font-family: Days One; align-items: center; color: #fff;">Payment</h2>
               
            </div> 
        </div>
            <form >
                
                <input type="text" name="price" placeholder="₹50/-" value="₹50/-" readonly required>
                <script src="https://checkout.razorpay.com/v1/checkout.js"></script>
                
                <button id="rzp-button" class="register-button" >Pay Now</button>
    ...
    <script>
        var options = {
          key: 'rzp_test_y4d5hTOIzs9cRs',
          amount: 5000, 
          currency: 'INR',
          name: 'Bharat Esports',
          description: 'Bharat eSports, where passion meets competition! ',
