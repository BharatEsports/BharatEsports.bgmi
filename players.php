...
<body>
    ...
    <div class="cplayers" >
      <div class="playerrow" >
          <h2 class="tittle5" style="font-family: Days One; align-items: center; ">PREVIOUS TOURNMENT WINNERS</h2>
      </div>
    ...
    <div class="cplayers" >
      <div class="playerrow" >
          <div style="font-family: Paytone One; font-size: 2em; color: #011C40;" >CHAMPIONS</div>
      </div>
  
      <div class="playerrow">
          <div class="playerbox" style="font-family: Paytone One; font-size: 2em; background-color: #011C40; color: #FFF;">
              <div >Name</div>
              
          </div>
      </div>
      <div class="playerrow" >
        <div style="font-family: Paytone One; font-size: 2em; color: #011C40;" >1st RUNNER-UP</div>
    </div>
    ...
    <div class="playerrow" >
      <div style="font-family: Paytone One; font-size: 2em; color: #011C40;" >2nd RUNNER-UP</div>
  </div>
  ...
  <div class="playerback">
    <a href="./main.php" style="color: #FFF;"><div class="back-button">
        <i class="fas fa-arrow-left"></i> Back
    </div></a>
    <a href="./pointstable.php" style="color: #FFF;"><div class="next-button">
        Points <i class="fas fa-arrow-right"></i>
    </div></a>
</div>
