...
<body>
    ...
    <div class="cplayers" >
      <div class="playerrow" >
          <h2 class="tittle5" style="font-family: Days One; align-items: center; ">POINTS TABLE</h2>
         
      </div> 
  </div>

  <div class="image-containerpoints">
    <img src="./images/points/points1.jpg" alt="Image 1">
    <img src="./images/points/points2.jpg" alt="Image 2">
