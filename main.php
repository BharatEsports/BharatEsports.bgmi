...
<body>
    ...
    <div class="gamebody">
        <div class="gamecolumn">
            <img src="images/previouswin.JPG" alt="Image 1" class="gameimage">
            <br>
            <br>
            <h2 class="tittle5" style="font-family: Days One; ">PREVIOUS TOURNMENT WINNERS</h2>
            <h2 class="tittle5" style="font-family: Days One; ">&</h2>
            <h2 class="tittle5" style="font-family: Days One; ">POINTS TABLE</h2>
        
            <a href="./players.php"><button class="buttongame" style="font-family: Days One; ">Check Here</button></a>
        </div>
    
        <div class="gamecolumn">
            <img src="images/slots.JPG" alt="Image 2" class="gameimage">
            <br>
            <br>
            <h2 class="tittle5" style="font-family: Days One; " >ONGOING TOURNMENTS</h2>
            <a href="./ongoing.php"><button class="buttongame" style="font-family: Days One; ">Register</button></a>
        </div>
    
        <div class="gamecolumn">
            <img src="images/ongoing.JPG" alt="Image 3" class="gameimage">
            <br>
            <br>
            <h2 class="tittle5" style="font-family: Days One; " >SLOT STATION</h2>
            <a href="./slotstation.php"><button class="buttongame" style="font-family: Days One; ">Check Here</button></a>
        </div>
        <div class="gamecolumn">
            <img src="images/upcoming.JPG" alt="Image 3" class="gameimage">
            <br>
            <br>
            <h2 class="tittle5" style="font-family: Days One; " >UPCOMING TOURNMENTS</h2>
            <a href="./upcoming.php"><button class="buttongame" style="font-family: Days One; ">Check Here</button></a>
        </div>
    </div>
    <div class="footer">
