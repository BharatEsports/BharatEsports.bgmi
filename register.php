...
<body>
  ...
  <div class="formcontainer">
    ...
    <div class="form-container">
      <div class="cplayers" >
        <div class="playerrow" >
            <h2 class="tittle5" style="font-family: Days One; align-items: center; color: #fff;">Register Your Team</h2>
           
        </div> 
    </div>
        <form action="https://script.google.com/macros/s/AKfycbzQmBgIbnVDtQhNuDMF7myqewPYv8w1TdWw38N9SBCuz39FkaUfdGxm_q6njgzzmwyAjw/exec" method="POST" name="Registration From" >
            <input type="text" id="name" name="TeamName" placeholder="Team Name*" required>
            <input type="text" id="name" name="Player-1" placeholder="Player 1 - In Game Name*" required>
            <input type="text" id="name" name="Player-2" placeholder="Player 2 - In Game Name*" required>
            <input type="text" id="name" name="Player-3" placeholder="Player 3 - In Game Name*" required>
            <input type="text" id="name" name="Player-4" placeholder="Player 4 - In Game Name" >
            <input type="text" id="name" name="Player-5" placeholder="Player 5 - In Game Name (Optional)" >
            <input type="text" id="phone" name="Whatsapp" placeholder="Whatsapp Number*" required>
            <input type="text" id="phone" name="phone" placeholder="Phone Number*" required>
            
            <button class="register-button" >Next</button>
            <p align="center" style="color: #fff; font-family: Days One; font-size: 15px;">After "Next" Wait Untill the "OK" Button Appears</p>
    ...
    <script>
      const scriptURL = 'https://script.google.com/macros/s/AKfycbzQmBgIbnVDtQhNuDMF7myqewPYv8w1TdWw38N9SBCuz39FkaUfdGxm_q6njgzzmwyAjw/exec'
    
      const form = document.forms['Registration From']
